...
# Supabase is optional. Install Supabase client packages only if you plan to use Supabase for frontend auth.
...
```env
## Supabase env vars removed from default example; set these only if you use Supabase for frontend auth
...
cd lux-ride-frontend
# Supabase is optional. Install Supabase client only if you plan to use Supabase for frontend auth.
npm install @stripe/stripe-js @stripe/react-stripe-js
```
...
// Supabase client removed from examples. If you use Supabase, initialize
// it like this (optional):
...
<html lang="en">
  <head>
    ...
    <!-- Supabase CDN removed from default example. Add it only if using Supabase. -->
